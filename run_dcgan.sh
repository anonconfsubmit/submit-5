...
pwd=`pwd`
common="python3 $pwd/dist-dcgan.py --size $n --master $master --local_steps $E --frac_workers $C --batch_size $B --sample $s --weight_avg $w --model $model --port $port --magic_num $magic --iid $iid"
r=0
while read node; do
